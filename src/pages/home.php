	...
	<main class="mt-20">
		...
		<section class="flex flex-col items-center justify-center p-4 mt-10 shadow-xl/30 shadow-white rounded-lg">
			<div class="mb-8">
				...
				<div class="grid grid-cols-3 mt-6 text-center">
					<div>
		...
		<section class="flex flex-col items-center justify-center mt-4 pl-8 pr-8">
			...
			<div class="grid grid-cols-1 gap-4 mt-6">
				<div class="bg-gray-800 h-120 w-120 pl-6 pr-6 pt-4 pb-4 text-center rounded-lg relative ">
					...
					<img src="../../public/assets/images/webfs-1.png" alt="Imagem Home Page Cabecalho Web FS" class="w-50 h-50 absolute top-30 left-10 z-0 shadow-xl/30 shadow-white">
					<img src="../../public/assets/images/webfs-2.png" alt="Imagem Home Page Serviços Web FS" class="w-50 h-50 absolute top-50 left-30 z-1 shadow-xl/30 shadow-white">
					<img src="../../public/assets/images/webfs-3.png" alt="Imagem Contato Web FS" class="w-50 h-50 absolute top-20 left-60 z-2 shadow-xl/30 shadow-white">
					<button class="bg-cyan-300 text-1xl text-gray-950 font-bold border-2 border-cyan-300 rounded-full pl-5 pr-5 pt-2 pb-2 hover:bg-cyan-400 hover:border-cyan-400 cursor-pointer" onclick="window.open('https://www.webfs.com.br/', '_blank')">
						Detalhes
					</button>
				</div>		
			</div>
